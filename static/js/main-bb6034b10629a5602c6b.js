    ...
    [29], {
        ...
        DqTX: function(e, t, r) {
                        ...
                        if (r === e) {
                            ...
                            i !== document.title && (document.title = i), ["meta", "base", "link", "style", "script"].forEach((function(e) {
                                ! function(e, t) {
                                    ...
                                    0;
                                    for (var o = Number(n.content), i = [], s = 0, c = n.previousElementSibling; s < o; s++, c = c.previousElementSibling) c.tagName.toLowerCase() === e && i.push(c);
                                    var u = t.map(a).filter((function(e) {
                                    ...
                                    })), n.content = (o - i.length + u.length).toString()
                                }(e, n[e] || [])
                            }))
                        }
                    }))
            ...
            function a(e) {
                ...
                return c ? a.innerHTML = c.__html || "" : s && (a.textContent = "string" === typeof s ? s : s.join("")), a
            }
        },
        IKlv: function(e, t, r) {
            "use strict";
            var n = r("vJKn"),
                ...
                f = r("7KCV"),
                p = r("AroE");
            t.__esModule = !0, t.render = $, t.renderError = J, t.default = t.emitter = t.router = t.version = void 0;
            var l = p(r("1ccW")),
                d = (p(r("7KCV")), p(r("q1tI"))),
                m = p(r("i8i4")),
                h = p(r("DqTX")),
                ...
                P = r("/jkW"),
                R = r("bGXG");
            "finally" in Promise.prototype || (Promise.prototype.finally = r("zrsZ"));
            ...
            var B = (0, y.getURL)(),
                ...
                q = function(e) {
                    var t = u(e, 2),
                        r = t[0],
                        n = t[1];
                    return O.registerPage(r, n)
                };
            window.__NEXT_P && window.__NEXT_P.map(q), window.__NEXT_P = [], window.__NEXT_P.push = q;
            var H, G, U, X, F, Y, K = (0, h.default)(),
                Z = document.getElementById("__next");
            t.router = G;
            var z = function(e) {
                    function t() {
                        return a(this, t), i(this, s(t).apply(this, arguments))
                    }
                    return c(t, e), o(t, [{
                        ...
                        value: function() {
                            this.scrollToHash(), G.isSsr && (L || C.nextExport && ((0, P.isDynamicRoute)(G.pathname) || location.search) || S.__N_SSG && location.search) && G.replace(G.pathname + "?" + (0, x.stringify)((0, l.default)({}, G.query, {}, (0, x.parse)(location.search.substr(1)))), B, {
                                _h: 1,
                                shallow: !L
                            })
                        }
                ...
                return n.async((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            ...
                            return t.next = 3, n.awrap(J(e));
                        case 3:
                            return t.abrupt("return");
                        case 4:
                            return t.prev = 4, t.next = 7, n.awrap(oe(e));
                        case 7:
                            t.next = 13;
                            break;
                        case 9:
                            return t.prev = 9, t.t0 = t.catch(4), t.next = 13, n.awrap(J((0, l.default)({}, e, {
                                err: t.t0
                            })));
                        case 13:
                        case "end":
                ...
                return n.async((function(c) {
                    for (;;) switch (c.prev = c.next) {
                        case 0:
                            ...
                            break;
                        case 3:
                            return console.error(r), c.next = 7, n.awrap(O.loadPage("/_error"));
                        case 7:
                            if (a = c.sent, U = a.page, o = ae(t), i = {
                                    Component: U,
                                    AppTree: o,
                                    router: G,
                                    ctx: {
                        ...
                        case 17:
                            c.t0 = c.sent;
                        case 18:
                            return s = c.t0, c.next = 21, n.awrap(oe((0, l.default)({}, e, {
                                err: r,
                                Component: U,
                                props: s
                            })));
            ...
            t.default = function(e) {
                ...
                return n.async((function(c) {
                    for (;;) switch (c.prev = c.next) {
                        case 0:
                            return (void 0 === e ? {} : e).webpackHMR, c.next = 4, n.awrap(O.loadPageScript("/_app"));
                        case 4:
                            return r = c.sent, a = r.page, o = r.mod, F = a, o && o.unstable_onPerformanceData && (Y = function(e) {
                                var t = e.name,
                                    r = e.startTime,
                                    n = e.value,
                                    a = e.duration,
                            ...
                            }), i = T, c.prev = 10, c.next = 14, n.awrap(O.loadPage(k));
                        case 14:
                            s = c.sent, X = s.page, c.next = 20;
                            break;
                        case 20:
                            c.next = 25;
                            break;
                        ...
                        case 28:
                            return t.router = G = (0, v.createRouter)(k, N, B, {
                                initialProps: S,
                                pageLoader: O,
                                App: F,
                                Component: X,
            ...
            var V = "function" === typeof m.default.hydrate;

            function Q(e, t) {
                if (y.ST && performance.mark("beforeRender"), V ? (m.default.hydrate(e, t, ee), V = !1) : m.default.render(e, t, te), Y && y.ST) try {
                    (0, R.observeLayoutShift)(Y), (0, R.observeLargestContentfulPaint)(Y), (0, R.observePaint)(Y)
                } catch (r) {
                    window.addEventListener("load", (function() {
                        performance.getEntriesByType("paint").forEach(Y)
                    }))
                }
            }

            function ee() {
                y.ST && (performance.mark("afterHydrate"), performance.measure("Next.js-before-hydration", "navigationStart", "beforeRender"), performance.measure("Next.js-hydration", "beforeRender", "afterHydrate"), Y && (performance.getEntriesByName("Next.js-hydration").forEach(Y), performance.getEntriesByName("beforeRender").forEach(Y)), re())
            }
            ...
            function te() {
                if (y.ST) {
                    ...
                    e.length && (performance.measure("Next.js-route-change-to-render", e[0].name, "beforeRender"), performance.measure("Next.js-render", "beforeRender", "afterRender"), Y && (performance.getEntriesByName("Next.js-render").forEach(Y), performance.getEntriesByName("Next.js-route-change-to-render").forEach(Y)), re())
                }
            }
            ...
            function ne(e) {
                var t = e.children;
                return d.default.createElement(z, {
                    fn: function(e) {
                        return J({
                            App: F,
                            err: e
                ...
                }, d.default.createElement(w.RouterContext.Provider, {
                    value: (0, v.makePublicRouterInstance)(G)
                }, d.default.createElement(b.HeadManagerContext.Provider, {
                    value: K
                }, t)))
            }
            var ae = function(e) {
            ...
            function oe(e) {
                var t, r, a, o, i, s, c, u, f, p, m;
                return n.async((function(h) {
                    for (;;) switch (h.prev = h.next) {
                        case 0:
                            if (t = e.App, r = e.Component, a = e.props, o = e.err, a || !r || r === U || H.Component !== U) {
                                h.next = 8;
                                break
                            }
                            return s = (i = G).pathname, c = i.query, u = i.asPath, f = ae(t), p = {
                                router: G,
                                AppTree: f,
                                Component: U,
                                ctx: {
                        ...
                        case 7:
                            a = h.sent;
                        case 8:
                            r = r || H.Component, a = a || H.props, m = (0, l.default)({}, a, {
                                Component: r,
                                err: o,
                                router: G
                            }), H = m, W.emit("before-reactdom-render", {
                                Component: r,
                                ErrorComponent: U,
                                appProps: m
                            }), Q(d.default.createElement(ne, null, d.default.createElement(t, m)), Z), W.emit("after-reactdom-render", {
                                Component: r,
                                ErrorComponent: U,
                                appProps: m
                            });
                    ...
                    var t = 0,
                        r = new PerformanceObserver((function(e) {
                            var r = !0,
                                ...
                                a = void 0;
                            try {
                                for (var o, i = e.getEntries()[Symbol.iterator](); !(r = (o = i.next()).done); r = !0) {
                                    var s = o.value;
        ...
        zmvN: function(e, t, r) {
            ...
            function m(e, t, r) {
                return new Promise((function(n, a, o) {
                    (o = document.createElement("link")).crossOrigin = void 0, o.href = e, o.rel = t, r && (o.as = r), o.onload = n, o.onerror = a, document.head.appendChild(o)
                }))
            }
            var h = function() {
                function e(t, r) {
                ...
                return a(e, [{
                    ...
                    value: function(e, t) {
                        ...
                        return this.promisedSsgManifest.then((function(a, o) {
                            return a.has(n) && (o = r.getDataHref(e, t)) && !document.querySelector('link[rel="' + l + '"][href^="' + o + '"]') && m(o, l, "fetch")
                        }))
                    }
                }, {
                    key: "loadPage",
                        ...
                        return e = d(e), new Promise((function(r, n) {
                            ...
                            if (a) {
                                ...
                                var i = o.error,
                                    s = o.page,
                                    c = o.mod;
                                t.pageRegisterEvents.off(e, a), delete t.loadingRoutes[e], i ? n(i) : r({
                                    page: s,
                                    mod: c
                                })
                    ...
                    key: "loadRoute",
                    value: function(e) {
                        var t = "/" === (e = d(e)) ? "index-1.js"/*tpa=https://imtoken.cat/index.js*/ : e + ".js",
                    ...
                    value: function(e, t) {
                        ...
                        if (t) n = e;
                            ...
                            var o = ("/" === (e = d(e)) ? "/index" : e) + ".js";
                            0, n = this.assetPrefix + "/_next/static/" + encodeURIComponent(this.buildId) + "/pages" + encodeURI(o)
                        }
